...
if exist "C:\Program Files\Google\Chrome\Application\chrome.exe" (
    start "" "C:\Program Files\Google\Chrome\Application\chrome.exe" --kiosk-printing "http://localhost:5175/QRV3NEW/"
) else (
    if exist "C:\Program Files (x86)\Google\Chrome\Application\chrome.exe" (
        start "" "C:\Program Files (x86)\Google\Chrome\Application\chrome.exe" --kiosk-printing "http://localhost:5175/QRV3NEW/"
    ) else (
        echo Chrome not found in standard locations. Trying Edge...
        start msedge --kiosk-printing "http://localhost:5175/QRV3NEW/"
    )
)
